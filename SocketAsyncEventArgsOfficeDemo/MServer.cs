    ...
    class MServer
    {
        ...
        public MServer(int numConnections, int receiveBufferSize)
        {
            ...
            m_bufferManager = new BufferManager(receiveBufferSize * numConnections * opsToPreEAlloc,
                                                receiveBufferSize);
            m_readWritePool = new SocketAsyncEventArgsPool(numConnections);     //初始化了SAEA对象池，最大容量为总连接数量
        ...
        private void ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (e.BytesTransferred > 0 && e.SocketError == SocketError.Success)
            {
                ...
                Console.WriteLine("Receive message :" + m_bufferManager.)
